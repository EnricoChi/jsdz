...
const player = {
  ...
  move(direction) {
    ...
    const increaseX = game.settings.colsCount - (this.x + 1) > game.settings.startPositionX,
      ...
      decreaseY = this.y > game.settings.startPositionY;
    ...
    switch (direction) {
      ...
      case 3:
        ...
        break;
      case 7:
        if (decreaseY && decreaseX) {
          this.y--;
          this.x--;
        }
        break;
      case 9:
        if (decreaseY && increaseX) {
          this.y--;
          this.x++;
        }
        break;
...
const game = {
  ...
  getDirection() {
    ...
    const availableDirections = [-1, 2, 4, 6, 8, 1, 3, 7, 9]; // Дз
